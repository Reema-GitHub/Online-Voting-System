 ...
 * @author Reema Mehta
 */
public class CreateVoterJPanel extends javax.swing.JPanel {
    private Voter voter;
    private JPanel userProcessContainer;
    private EcoSystem system;
    private Pattern pattern;
    private Matcher matcher;
    private VoterDirectory directory;
    private Enterprise enterprise;
    /**
     * Creates new form CreateVoterJPanel
     */
 

    public CreateVoterJPanel(JPanel userProcessContainer, EcoSystem system) {
       initComponents();
       this.system=system;
   ...
   if(!matcher.matches())
       ...
       Voter voter = system.getVoterDirectory().createVoter();
       ...
       jDateChooser1.setDateFormatString("MM/dd/yyyy");
        ...
        voter.setDOB(sdf.format(jDateChooser1.getDate()));
        voter.setPpnumber(jTextField7.getText());
        voter.setApproved(false);
        
        JOptionPane.showMessageDialog(this,"Voter Details updated successfully","Information" ,JOptionPane.INFORMATION_MESSAGE );
