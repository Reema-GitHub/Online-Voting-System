...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public void populateEmployeeComboBox(Organization1 organization){
        employeeJComboBox.removeAllItems();
        
        for (Candidate employee : organization.getCandidateDirectory().getCandidateList()){
            employeeJComboBox.addItem(employee);
        }
    }
    
    private void populateRoleComboBox(Organization1 organization){
        roleJComboBox.removeAllItems();
        for (Role1 role : organization.getSupportedRole()){
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        Organization1 organization = (Organization1) organizationJComboBox.getSelectedItem();
        Candidate employee = (Candidate) employeeJComboBox.getSelectedItem();
        Role1 role = (Role1) roleJComboBox.getSelectedItem();
