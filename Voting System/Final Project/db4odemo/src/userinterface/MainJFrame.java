...
import userinterface.Candidaterole.CreateCandidateJPanel;
import userinterface.Voterrole.CreateVoterJPanel;
...
public class MainJFrame extends javax.swing.JFrame {
   ...
   // private   Organization1 inOrganization;
    ...
    private void initComponents() {
        ...
        BtnVoter.setText("Voter Registration");
        ...
        Candidatebtn.setText("Candidate Registration");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(BtnVoter, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        //Step1: Check in the ecosystem admin user account directory if you have the user
        UserAccount userAccount=ecosystem.getUserAccountDirectory().authenticateUser(userName, password);
        
        Enterprise inEnterprise=null;
        Organization1 inOrganization=null;
...
//                       for(Organization1 organization:enterprise.getOrganizationDirectory().getOrganizationList()){
...
//        
    ...
    private void BtnVoterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVoterActionPerformed
       ...
       CreateVoterJPanel createvoterJPanel = new CreateVoterJPanel(userProcessContainer, ecosystem);
       userProcessContainer.add("CreateVoterJPanel",createvoterJPanel);
       CardLayout layout=(CardLayout)userProcessContainer.getLayout();
       layout.next(userProcessContainer); 
    ...
    private void CandidatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CandidatebtnActionPerformed
      ...
      CreateCandidateJPanel createcandidateJPanel = new CreateCandidateJPanel(userProcessContainer, ecosystem);
       userProcessContainer.add("CreateCandidateJPanel",createcandidateJPanel);
       CardLayout layout=(CardLayout)userProcessContainer.getLayout();
       layout.next(userProcessContainer);
